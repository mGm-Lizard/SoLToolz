...
final function ModifyMenu ()
{
  ...
  if ( Menu != None )
  {
    for ( i=0; i<Menu.C_Main.TabStack.Length;i++ ) //Find PlayerLoginControls in the GUITabButton array 'TabStack'
    {
      ...
      {
          case class'UT2k4Tab_PlayerLoginControlsOnslaught': replacementClass = "SoLToolzv12.XNEWTab_PlayerLoginControlsOnslaught";
          case class'UT2k4Tab_PlayerLoginControlsInvasion':  replacementClass = "SoLToolzv12.XNEWTab_PlayerLoginControlsInvasion";
          default: replacementClass = "SoLToolzv12.XNEWTab_PlayerLoginControls";
      }
    }
